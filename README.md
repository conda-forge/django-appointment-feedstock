About django-appointment-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-appointment-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-appointment-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-appointment
# for installing globally
pixi global install django-appointment
```
...
It is possible to list all of the versions of `django-appointment` available on your platform:
...
```
pixi search django-appointment --channel conda-forge
```
